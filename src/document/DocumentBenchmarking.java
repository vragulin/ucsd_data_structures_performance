	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 *      (on the same line as the first print statement) followed by a tab (\t) */
			 double tBasicStart = (double) System.nanoTime()/1_000_000_000;
			 //System.out.print("start: " + tBasicStart + "\t");
			 for (int i=0; i<trials; i++) {
				 BasicDocument basic = new BasicDocument(chars);
				 basic.getFleschScore();
			 }
			 double tBasicEnd = (double) System.nanoTime()/1_000_000_000;
			 System.out.print((tBasicEnd - tBasicStart) + "\t");
			 ...
			 */  
			 double tEfficientStart = (double) System.nanoTime()/1_000_000_000;
			 for (int i=0; i<trials; i++) {
				 EfficientDocument efficient = new EfficientDocument(chars);
				 efficient.getFleschScore();
			 }
			 double tEfficientEnd = (double) System.nanoTime()/1_000_000_000;
			 System.out.print((tEfficientEnd - tEfficientStart) + "\t" + "\n");
